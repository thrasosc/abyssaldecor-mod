...
public class BlockRegistry {
    ...
    public static final RegistrySupplier<Block> PEARLY_GLASS_BLOCK = BLOCKS.register("pearly_glass_block", () -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.GLASS)));
    public static final RegistrySupplier<BlockItem> PEARLY_GLASS_ITEM = BLOCK_ITEMS.register(PEARLY_GLASS_BLOCK.getId(), () -> new BlockItem(PEARLY_GLASS_BLOCK.get(), new Item.Properties().arch$tab(ABYSSALDECOR_TAB)));

    public static final RegistrySupplier<Block> SUNNY_PEARLY_GLASS_BLOCK = BLOCKS.register("pearly_glass_block_sunny", () -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.GLASS)));
    ...
    public static final RegistrySupplier<Block> AZURE_PEARLY_GLASS_BLOCK = BLOCKS.register("pearly_glass_block_azure", () -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.GLASS)));
    ...
    public static final RegistrySupplier<Block> VERDANT_PEARLY_GLASS_BLOCK = BLOCKS.register("pearly_glass_block_verdant", () -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.GLASS)));
    ...
    public static final RegistrySupplier<Block> WHITEWOOD_PEARLY_GLASS_BLOCK = BLOCKS.register("pearly_glass_block_whitewood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.GLASS)));
    ...
    public static final RegistrySupplier<Block> BLACKWOOD_PEARLY_GLASS_BLOCK = BLOCKS.register("pearly_glass_block_blackwood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.GLASS)));
    ...
    public static final RegistrySupplier<Block> WHITE_WOOD_PLANKS_BLOCK = BLOCKS.register("white_wood_planks", () -> new Block(BlockBehaviour.Properties.copy(OAK_PLANKS)));
    ...
    public static final RegistrySupplier<Block> WHITE_WOOD_STAIRS_BLOCK = BLOCKS.register("white_wood_stairs", () -> new StairBlock(OAK_PLANKS.defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS)));
    ...
    public static final RegistrySupplier<Block> WHITE_WOOD_BUTTON_BLOCK = BLOCKS.register("white_wood_button", () -> woodenButton(BlockSetType.OAK));
    ...
    public static final RegistrySupplier<Block> WHITE_WOOD_FENCE_BLOCK = BLOCKS.register("white_wood_fence", () -> new FenceBlock(BlockBehaviour.Properties.of().mapColor(OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).ignitedByLava()));
    ...
    public static final RegistrySupplier<Block> WHITE_WOOD_FENCE_GATE_BLOCK = BLOCKS.register("white_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava(), WoodType.OAK));
    ...
    public static final RegistrySupplier<Block> WHITE_WOOD_PLANTER_BLOCK = BLOCKS.register("white_wood_planter", () -> new FarmBlock(BlockBehaviour.Properties.copy(FARMLAND)));
